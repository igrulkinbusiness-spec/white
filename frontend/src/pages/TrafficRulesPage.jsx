...
export const TrafficRulesPage = () => {
  ...
  return (
    <div data-testid="traffic-rules-page">
      ...
      <section className="py-12 bg-italia-red/10" data-testid="left-warning">
        <div className="container mx-auto px-4 md:px-8 max-w-7xl">
          <div className="flex items-center gap-6">
            ...
            <div>
              <h2 className="font-serif text-2xl font-medium text-italia-text mb-2">Drive on the LEFT!</h2>
              <p className="text-italia-text-muted">
                Ireland drives on the left side of the road. Take extra care at roundabouts (go CLOCKWISE), 
                junctions, and when pulling out. Most accidents involving tourists happen in the first few hours!
              </p>
            </div>
          </div>
        </div>
      ...
      <ContentSection title="Main Rules" subtitle="Know Before You Go" id="rules">
      ...
      <section className="py-16 bg-white" data-testid="documents-section">
        <div className="container mx-auto px-4 md:px-8 max-w-7xl">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <div>
              <InfoCard icon={AlertTriangle} variant="warning" title="Penalty Points System" className="mb-6">
                <p className="mt-2">Ireland uses a penalty points system. Accumulating 12 points results in a 6-month driving ban.</p>
                <p className="mt-2">Points stay on your licence for 3 years. Some offences result in immediate disqualification.</p>
              </InfoCard>
              
              <InfoCard icon={Phone} title="Emergency Numbers">
                <ul className="space-y-2 mt-3 font-mono">
                  <li><strong>999 / 112</strong> — Emergency (Gardaí, Fire, Ambulance)</li>
                  <li><strong>1800 250 025</strong> — AA Roadside (members)</li>
                  <li><strong>1800 667 788</strong> — AA Roadside (non-members)</li>
                </ul>
              </InfoCard>
            </div>
          </div>
      ...
      <ContentSection title="Fines & Penalties" subtitle="Know the Consequences" id="fines">
        <div className="overflow-x-auto">
          <table className="w-full border-collapse">
            <thead>
              <tr className="border-b-2 border-italia-red">
                <th className="text-left py-4 pr-4 font-mono text-xs uppercase tracking-wider text-italia-text-muted">Violation</th>
                <th className="text-left py-4 pr-4 font-mono text-xs uppercase tracking-wider text-italia-text-muted">Fine</th>
                <th className="text-left py-4 font-mono text-xs uppercase tracking-wider text-italia-text-muted">Points</th>
              </tr>
            </thead>
            <tbody>
        ...
        <div className="mt-8 p-6 bg-italia-green text-white">
          <h3 className="font-serif text-xl font-medium mb-2">Fixed Charge Notices</h3>
          <p className="text-white/90">
            If you receive a fixed charge notice, pay within 28 days to avoid increased fines or court proceedings. 
            After 56 days, the fine increases by 50% and you may be summonsed to court.
          </p>
        </div>
      </ContentSection>
    </div>
